...
export function Projects() {
  const projects = [
    ...
    {
      title: "Nevaeh Solutions Revamp",
      description:
        "A clean, informative site designed to showcase software development services—featuring Website, Web App, and Mobile App development with clear offerings, transparent pricing, and seamless contact access.",
      image: "/nevaeh.png",
      tech: ["FIGMA", "Next.js", "Tailwind CSS", "Vercel"],
      liveIcon: ExternalLink,
      codeIcon: CodeIcon,
      liveUrl: "https://www.nevaeh.co.za/",
      githubUrl: "https://github.com/ethandiedericks/nevaeh-v3",
      liveLabel: "Live Demo",
      codeLabel: "Code",
    },
  ];
